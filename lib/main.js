...
function postCheckRun(lints) {
    return __awaiter(this, void 0, void 0, function* () {
        const annotations = lints.map(annotations_1.getAnnotationForLint);
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const output = yield eslint_1.runEslint(patterns, { cwd });
        const lints = eslint_1.parseEslints(output);
        yield postCheckRun(lints);
    });
}
run().catch(err => {
    core.error(err);
